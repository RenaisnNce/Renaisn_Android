...
import com.renaisn.reader.constant.AppConst.dateFormat
...
import com.renaisn.reader.help.http.BackstageWebView
import com.renaisn.reader.help.http.CookieStore
import com.renaisn.reader.help.http.SSLHelper
...
//******************文件操作************************//
     ...
     * 解析字体,返回字体解析类
     */
    fun queryBase64TTF(base64: String?): com.renaisn.reader.model.analyzeRule.QueryTTF? {
        base64DecodeToByteArray(base64)?.let {
            return com.renaisn.reader.model.analyzeRule.QueryTTF(it)
        }
        return null
    }
     ...
     */
    fun queryTTF(str: String?): com.renaisn.reader.model.analyzeRule.QueryTTF? {
        str ?: return null
        try {
            ...
            font ?: return null
            qTTF = com.renaisn.reader.model.analyzeRule.QueryTTF(font)
    ...
    fun replaceFont(
        text: String,
        errorQueryTTF: com.renaisn.reader.model.analyzeRule.QueryTTF?,
        correctQueryTTF: com.renaisn.reader.model.analyzeRule.QueryTTF?
    ): String {
