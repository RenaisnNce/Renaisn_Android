package com.renaisn.reader.help.config
...
object AppConfig : SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    var isEInkMode = appCtx.getPrefString(PreferKey.themeMode,"0") == "3"
    ...
    override fun onSharedPreferenceChanged(sharedPreferences: SharedPreferences?, key: String?) {
        when (key) {
            PreferKey.themeMode -> isEInkMode = appCtx.getPrefString(PreferKey.themeMode,"0") == "3"
    ...
    var enableReview: Boolean
        get() = appCtx.getPrefBoolean(PreferKey.enableReview, false) && com.renaisn.reader.BuildConfig.DEBUG
        set(value) {
    ...
    val webDavDir get() = appCtx.getPrefString(PreferKey.webDavDir, "renaisn")
    ...
    private fun getPrefUserAgent(): String {
        ...
        if (ua.isNullOrBlank()) {
            return "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/" + com.renaisn.reader.BuildConfig.Cronet_Main_Version + " Safari/537.36"
        }
        return ua
    }
