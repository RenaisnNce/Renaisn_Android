...
package com.renaisn.reader.ui.widget.code
...
val renaisnPattern: Pattern = Pattern.compile("\\|\\||&&|%%|@js:|@Json:|@css:|@@|@XPath:")
...
fun CodeView.addRenaisnPattern() {
    addSyntaxPattern(renaisnPattern, appCtx.color(R.color.md_orange_900))
}
