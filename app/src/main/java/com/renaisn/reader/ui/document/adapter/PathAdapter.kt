...
import com.renaisn.reader.databinding.ItemPathFilepickerBinding
...
class PathAdapter(context: Context, val callBack: CallBack) :
    ...
    private val arrowIcon = ConvertUtils.toDrawable(com.renaisn.reader.ui.document.utils.FilePickerIcon.getArrow())
