...
## 对外提供api
-keep class com.renaisn.reader.api.ReturnData{*;}
...
# Class.forName调用
-keep class com.renaisn.reader.lib.cronet.CronetInterceptor{*;}
-keep class com.renaisn.reader.lib.cronet.CronetLoader{*;}
-keep class com.renaisn.reader.help.AppUpdateGitHub{*;}
